...
class MrpProduction(models.Model):
    ...
    def action_open_work_sheet_wizard(self):
        resultant_products = [self.product_id] * max(int(self.n_cuts) - 1, 0)
        for move in self.move_finished_ids:
            resultant_products += [move.product_id] * int(move.n_cuts)
        ...
        return {    
            ...
            'context': {
                ...
                'default_resultant_products_ids': [(6, 0, list(set(p.id for p in resultant_products)))], 
